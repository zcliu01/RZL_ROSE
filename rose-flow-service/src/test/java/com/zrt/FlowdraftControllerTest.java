...
@SpringApplicationConfiguration(classes = FlowdraftControllerTest.class)
public class FlowdraftControllerTest {
    ...
    @Test
    public void flowdraftList() {
        Map<String, Object> appMap = new HashedMap();

        try {
            String result = template.postForObject(base.toString()+"/v1.0/flowdraft/list", buildEntity(appMap), String.class);
