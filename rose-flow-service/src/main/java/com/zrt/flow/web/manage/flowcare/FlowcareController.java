package com.zrt.flow.web.manage.flowcare;
...
@RestController
@RequestMapping("/v1.0/flowcare")
public class FlowcareController {
    ...
    public Map<String, Object> careList(@RequestBody Map<String, Object> map) throws Exception {
        log.info("Server端的FlowcareController中careList方法");
        ResultMap resultMap = new ResultMap();
        try {

            Map<String, Object> resMap = flowcareService.flowcareList(map);
