package com.zrt.flow.web.app.appflowEntrust;
...
@RestController
@RequestMapping("/v1.0/appFlowentrust")
public class AppFlowEntrustController {
	private static final Logger log = LoggerFactory.getLogger(AppFlowEntrustController.class);
	...
	public Map<String, Object> list(@RequestBody Map<String, Object> map) throws Exception {
		log.info("Server端的AppFlowEntrustController中list方法");
		ResultMap resultMap = new ResultMap();
		try {

			Map<String, Object> resMap = flowEntrustService.getAppEntrustList(map);
	...
	public Map<String, Object> ent(@RequestBody Map<String, Object> map) throws Exception {
		log.info("Server端的AppFlowEntrustController中ent方法");
		ResultMap resultMap = new ResultMap();
		try {
	...
	public Map<String, Object> cancel(@RequestBody Map<String, Object> map) throws Exception {
		log.info("Server端的AppFlowEntrustController中cancel方法");
		ResultMap resultMap = new ResultMap();
		try {
