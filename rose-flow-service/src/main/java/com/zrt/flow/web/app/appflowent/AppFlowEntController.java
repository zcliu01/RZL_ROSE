package com.zrt.flow.web.app.appflowent;
...
@RestController
@RequestMapping("/v1.0/appFlowent")
public class AppFlowEntController {
	...
	public Map<String, Object> list(@RequestBody Map<String, Object> map) throws Exception {
		...
		try {
			...
			Map<String, Object> resMap = flowEntrustService.getAppList(map);
