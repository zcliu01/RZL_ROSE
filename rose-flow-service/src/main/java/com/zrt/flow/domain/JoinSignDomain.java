...
public class JoinSignDomain {
	...
	private List<JoinSignFileDomain> signFlieList;
	private List<JoinSignRelevanceDomain> signRelList;
	...
	public List<JoinSignFileDomain> getSignFlieList() {
		return signFlieList;
	}

	public void setSignFlieList(List<JoinSignFileDomain> signFlieList) {
		this.signFlieList = signFlieList;
	}

	public List<JoinSignRelevanceDomain> getSignRelList() {
		return signRelList;
	}

	public void setSignRelList(List<JoinSignRelevanceDomain> signRelList) {
		this.signRelList = signRelList;
	}
