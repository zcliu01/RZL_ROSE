package com.zrt.sec.web.roleCheck;
...
@RestController
@RequestMapping("/v1.0/secCheck")
public class RoleCheckController {
	private static final Logger log = LoggerFactory.getLogger(RoleCheckController.class);
	...
	public Map<String, Object> roleList(@RequestBody Map<String, Object> appMap) throws Exception {
		...
		try {
			...
			// 获取用户角色列表
			appMap.put("role_type", "1");// 角色类型；1：审批角色
