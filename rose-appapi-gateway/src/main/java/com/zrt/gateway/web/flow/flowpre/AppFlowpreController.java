...
@RestController
@RequestMapping(value = "/v1.0/appFlowpre", produces = { "application/json;charset=UTF-8" })
public class AppFlowpreController extends BaseController {
	...
	public ResponseEntity<String> list(@RequestBody Map<String, Object> requestMap, @CookieValue String emp_id)
			throws Exception {
		log.info("Server端的AppFlowpreController中list方法");
