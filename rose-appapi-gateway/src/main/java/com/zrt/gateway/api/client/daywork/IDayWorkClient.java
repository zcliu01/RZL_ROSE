...
public interface IDayWorkClient extends DayWorkConstant {
	...
	@RequestMapping(value = DELETELIST, method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_UTF8_VALUE, consumes = MediaType.APPLICATION_JSON_UTF8_VALUE)
	@ResponseBody
	public Map<String, Object> deleteList(Map<String, Object> requestMap);
	
	@RequestMapping(value = SEARCHDATE , method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_UTF8_VALUE, consumes = MediaType.APPLICATION_JSON_UTF8_VALUE)
	@ResponseBody
	public Map<String, Object> searchDate(Map<String, Object> requestMap);
