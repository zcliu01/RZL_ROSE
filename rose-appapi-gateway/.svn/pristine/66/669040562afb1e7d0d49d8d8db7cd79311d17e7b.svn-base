...
@RestController
@RequestMapping(value = "/v1.0/pcVm", produces = { "application/json;charset=UTF-8" })
public class PcMeetingController extends BaseController {
	private static final Logger log = LoggerFactory.getLogger(PcMeetingController.class);
