 ...
 *         &lt;element ref="{http://portal.vidyo.com/admin/v1_1}LectureModeParticipant" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetLectureModeParticipantsResponse {
    ...
    @XmlElementRef(name = "lectureMode", namespace = "http://portal.vidyo.com/admin/v1_1", type = JAXBElement.class, required = false)
     ...
     * This is why there is not a <CODE>set</CODE> method for the lectureModeParticipant property.
     * 
     * <p>
    ...
    public List<LectureModeParticipant> getLectureModeParticipant() {
        if (lectureModeParticipant == null) {
            lectureModeParticipant = new ArrayList<LectureModeParticipant>();
        }
