 ...
 */
@RestController
@RequestMapping(value="/v1.0/flowcare", produces = { "application/json;charset=UTF-8" })
public class FlowcareController extends BaseController{
	private static final Logger log = LoggerFactory.getLogger(FlowcareController.class);
	...
	@ResponseBody
	public ResponseEntity<String> careList(@RequestBody Map<String, Object> requestMap, @CookieValue String emp_id) throws Exception {
		log.info("Server端的FlowcareController中list方法");
	...
	@ResponseBody
	public ResponseEntity<String> careSave(@RequestBody Map<String, Object> requestMap, @CookieValue String emp_id) throws Exception {
