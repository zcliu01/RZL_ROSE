 ...
 */
@RestController
@RequestMapping(value = "/v1.0/file", produces = {"application/json;charset=UTF-8"})
public class FileController extends BaseController {
    ...
    public ResponseEntity<String> uploadSingleFile(@RequestBody Map<String, Object> appMap) throws Exception {
        log.error("FileController中uploadSingleFile方法");
     ...
     * @throws Exception
     */
    /*@RequestMapping(value = "/searchFile", method = RequestMethod.POST, consumes = ApiConstant.CONSUMES, headers = ApiConstant.HEADERS)
    @ResponseBody
    public ResponseEntity<String> searchFile(@RequestBody Map<String, Object> appMap, @CookieValue String emp_id) throws Exception {
    ...
    @ResponseBody
    public ResponseEntity<String> fileList(@RequestBody Map<String, Object> appMap,@CookieValue String emp_id) throws Exception {
    ...
    @ResponseBody
    public ResponseEntity<String> deleteFile(@RequestBody Map<String, Object> appMap,@CookieValue String emp_id) throws Exception {
    ...
    @ResponseBody
    public ResponseEntity<String> downloadFile(@RequestBody Map<String, Object> appMap,@CookieValue String emp_id) throws Exception {
    ...
    @ResponseBody
    public ResponseEntity<String> copyFile(@RequestBody Map<String, Object> appMap,@CookieValue String emp_id) throws Exception {
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/share", method = RequestMethod.POST, consumes = ApiConstant.CONSUMES, headers = ApiConstant.HEADERS)
    @ResponseBody
    public ResponseEntity<String> share(@RequestBody Map<String, Object> appMap,@CookieValue String emp_id) throws Exception {
    	log.info("FileController中share方法");
    	appMap.put("emp_id", emp_id);
    	Map<String, Object> resultMap = iVifClient.share(appMap);
    	return response(resultMap);
    }
}
