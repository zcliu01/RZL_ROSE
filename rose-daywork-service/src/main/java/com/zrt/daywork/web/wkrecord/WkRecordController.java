package com.zrt.daywork.web.wkrecord;
...
@RestController
@RequestMapping("/v1.0/daywork")
public class WkRecordController {
	private static final Logger log = LoggerFactory.getLogger(WkRecordController.class);
